 ...
 */
$config['site_title']                 = "Apost.ru";       // Site Title, example.com
$config['admin_email']                = "admin@apost.ru"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 86500;                 // The number of seconds to lockout an account due to exceeded attempts
